...
from .views import (
    ...
    TeacherCourseSectionReorderView,
...
urlpatterns = [
    ...
    path("admin/courses/<uuid:course_id>/sections/reorder/", AdminOwnedCourseSectionReorderView.as_view(), name="admin-owned-course-sections-reorder"),
    path("admin/sections/<uuid:section_id>/reorder/", AdminOwnedSectionReorderView.as_view(), name="admin-owned-section-reorder"),
    ...
    path("teacher/courses/<uuid:course_id>/sections/reorder/", TeacherCourseSectionReorderView.as_view(), name="teacher-course-sections-reorder"),
    path("teacher/sections/<uuid:section_id>/reorder/", TeacherSectionReorderView.as_view(), name="teacher-section-reorder"),
