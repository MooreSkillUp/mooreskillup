...
# The API key decides the backend, rather than a second variable that can
# disagree with it. See common/mail_backend.py for why.
EMAIL_BACKEND = choose_email_backend(
    os.getenv("EMAIL_BACKEND", ""), ANYMAIL["BREVO_API_KEY"]
)
