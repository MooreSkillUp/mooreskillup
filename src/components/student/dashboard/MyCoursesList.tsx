  ...
  return (
    <section>
      <div className="mb-4 flex items-center justify-between">
        ...
        <Link href="/dashboard/courses?tab=my-courses" className="text-xs font-semibold text-primary hover:underline">
          View all →
        </Link>
      </div>
      ...
      {isLoading ? (
        ...
        <div className="rounded-[2rem] border border-dashed border-border bg-card p-12 text-center">
          ...
          <Link href="/dashboard/courses?tab=browse" className="mt-5 inline-block">
