  ...
  return (
    <main>
      <section className="relative overflow-hidden">
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_top_left,_rgba(11,100,244,0.2),transparent_34%)]" />
        <div className="mx-auto grid max-w-7xl gap-12 px-4 py-16 sm:px-6 lg:grid-cols-[1.2fr_0.8fr] lg:px-8 lg:py-24">
          ...
          <motion.div
            ...
            className="relative rounded-[2rem] border border-border bg-card/80 p-6 backdrop-blur"
          >
            <div className="rounded-[1.6rem] bg-gradient-to-br from-primary to-accent p-6 text-primary-foreground">
      ...
      <section className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-6 lg:grid-cols-3">
          {pricingPlans.map((plan) => (
            <div
              key={plan.id}
              className={`rounded-[2rem] border p-6 ${plan.highlight
      ...
      <section className="mx-auto max-w-7xl px-4 pb-20 sm:px-6 lg:px-8">
        <div className="rounded-[2rem] border border-border bg-gradient-to-br from-primary to-accent p-8 text-primary-foreground shadow-sm">
