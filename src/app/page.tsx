  ...
  return (
    <PublicShell>
      <main className="relative overflow-hidden">
        {/* Background (decorative only — must never capture clicks) */}
        <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_top_left,_rgba(11,100,244,0.18),transparent_35%),radial-gradient(circle_at_bottom_right,_rgba(245,130,32,0.14),transparent_35%)]" />

        <section className="relative mx-auto flex min-h-[85vh] max-w-7xl items-center px-4 py-20 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <motion.div
                ...
                className="inline-flex items-center gap-2 rounded-full border border-border bg-card/70 px-3 py-1 text-xs font-semibold text-muted-foreground shadow-sm"
              >
                <Rocket className="h-5.5 w-3.5 text-accent" />
                 Welcome to MooreSkillUp
              </motion.div>
            ...
            >
              Welcome to MooreSkillUp, your learning hub for developing
              practical skills, completing guided learning paths, tracking
              progress, and earning certifications that showcase your growth.
            </motion.p>
            ...
            >
              <div className="rounded-3xl border border-border bg-card p-6 shadow-sm">
                ...
                <p className="mt-2 text-sm text-muted-foreground">
                  Follow organized learning paths designed to help you
                  build valuable skills step-by-step.
                </p>
              </div>
              ...
              <div className="rounded-3xl border border-border bg-card p-6 shadow-sm">
                ...
                <p className="mt-2 text-sm text-muted-foreground">
                  Stay motivated with progress tracking, assessments,
                  milestones, and learning achievements.
                </p>
              </div>

              <div className="rounded-3xl border border-border bg-card p-6 shadow-sm">
                <div className="mx-auto flex h-12 w-12 items-center justify-center rounded-2xl bg-green-500/10 text-green-500">
                ...
                <p className="mt-2 text-sm text-muted-foreground">
                  Complete courses and showcase your accomplishments
                  with certificates and project-based learning.
                </p>
              </div>
            </motion.div>
          </div>
        ...
        <section className="relative px-4 pb-16 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-5xl overflow-hidden rounded-[2rem] border border-border bg-gradient-to-r from-primary/10 via-background to-accent-soft p-8 sm:p-10">
            <div className="flex flex-col items-start gap-6 sm:flex-row sm:items-center sm:justify-between">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h2 className="font-display text-2xl font-bold sm:text-3xl">Verify a certificate</h2>
                  <p className="mt-2 max-w-xl text-muted-foreground">
                    Hiring or checking a credential? Enter a MooreSkillUp certificate ID to confirm
                    instantly whether it&apos;s authentic.
                  </p>
                </div>
              </div>
              <Link
                href="/verify"
                className="inline-flex shrink-0 items-center gap-2 rounded-2xl bg-primary px-6 py-3 font-semibold text-primary-foreground shadow-sm transition duration-200 hover:-translate-y-0.5 hover:bg-primary/90 hover:shadow-lg"
              >
