...
type Handoff = { email: string; password: string; context: string };
...
/** Shown once, only when email couldn't carry the password to the teacher. */
function CredentialHandoff({ handoff, onDone }: { handoff: Handoff; onDone: () => void }) {
