      ...
      <div className="mx-auto max-w-4xl space-y-6">
          ...
          <section className="rounded-xl border border-border bg-card p-5 shadow-sm">
            ...
            <ol className="space-y-2.5 text-sm text-foreground">
              <li className="flex gap-2">
                <span className="font-semibold text-accent">1.</span> Watch the
                lesson video end to end.
              </li>
              <li className="flex gap-2">
                <span className="font-semibold text-accent">2.</span> Recreate
                the example shown in your own editor.
              </li>
              <li className="flex gap-2">
                <span className="font-semibold text-accent">3.</span> Write a
                two-line summary in the notes panel.
              </li>
              <li className="flex gap-2">
                <span className="font-semibold text-accent">4.</span> Mark the
                lesson as complete.
              </li>
            </ol>
          </section>
        ...
        <div className="flex flex-wrap items-center justify-between gap-3 rounded-xl border border-border bg-card p-5 shadow-sm">
          <div className="text-sm text-muted-foreground">
            {completed
              ? "Great work. This lesson is complete."
              : "Finished? Mark it done to unlock the next one."}
          </div>
          <Button
