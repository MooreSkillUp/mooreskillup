...
function SettingsPage() {
  ...
  const onProfile = (e: React.FormEvent) => {
    e.preventDefault();
    updateUser({ username: form.username, email: form.email, displayName: form.username });
    setSaved(true);
    ...
    <AppShell>
      <div className="mx-auto max-w-3xl space-y-6">
        ...
        <section className="rounded-xl border border-border bg-card p-6 shadow-sm">
          ...
          <p className="mt-1 text-sm text-muted-foreground">Update your username and email.</p>
        ...
        <section className="rounded-xl border border-border bg-card p-6 shadow-sm">
          ...
          <p className="mt-1 text-sm text-muted-foreground">UI only — backend wiring comes later.</p>
          <form
